    ...
    return Row(
      children: <Widget>[
        ...
        IconButton(
          ...
          onPressed: () {
            _launchURL("https://facebook.com/ayesha");
          },
        ),
        ...
        IconButton(
          ...
          onPressed: () {
            _launchURL("https://github.com/ayeshahabib");
          },
        ),
        const SizedBox(width: 5.0),
        IconButton(
          ...
          onPressed: () {
            _launchURL("https://youtube.com/c/ayesha");
          },
        ),
      ...
      children: <Widget>[
        ...
        SizedBox(
            ...
            child: CircleAvatar(
                ...
                child: CircleAvatar(
                    radius: 35.0, backgroundImage: NetworkImage('assets/images/ProfilePic2.png')))),
        const SizedBox(width: 20.0),
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
